...
describe 'Error' do
  ...
  describe 'test attribute "code"' do
    it 'should work' do
       ...
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["MissingProperty", "MalformedData", "NotFound", "ServiceError", "Internal", "InvalidRange", "NotSupported", "NotAllowed", "BadCertificate"])
