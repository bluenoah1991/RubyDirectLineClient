...
describe 'ConversationsApi' do
  ...
  # unit tests for conversations_get_messages
  ...
  # @return [MessageSet]
  describe 'conversations_get_messages test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for conversations_new_conversation
  # Start a new conversation
  # 
  # @param [Hash] opts the optional parameters
  # @return [Conversation]
  describe 'conversations_new_conversation test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for conversations_post_message
  # Send a message
  # 
  # @param conversation_id Conversation ID
  ...
  # @param [Hash] opts the optional parameters
  # @return [ErrorMessage]
  describe 'conversations_post_message test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for conversations_upload
  # Upload file(s) and send as attachment(s)
  # 
  # @param conversation_id 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'conversations_upload test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
