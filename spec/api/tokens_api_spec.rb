...
describe 'TokensApi' do
  ...
  # unit tests for tokens_generate_token_for_new_conversation
  # Generate a token for a new conversation
  # 
  # @param [Hash] opts the optional parameters
  # @return [String]
  describe 'tokens_generate_token_for_new_conversation test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for tokens_renew_token
  # Renew a token for a conversation
  # 
  # @param conversation_id 
  # @param [Hash] opts the optional parameters
  # @return [String]
  describe 'tokens_renew_token test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
