...
module SwaggerClient
  # A communication message sent to/from Direct Line
  class Message
    # ID for this message
    attr_accessor :id
    ...
    # Identity of the sender of this message
    attr_accessor :from

    # Text in this message
    attr_accessor :text

    # Opaque block of data passed to/from bot via the ChannelData field
    attr_accessor :channel_data

    # Array of URLs for images included in this message
    attr_accessor :images

    # Array of non-image attachments included in this message
    ...
    def hash
      [id, conversation_id, created, from, text, channel_data, images, attachments, e_tag].hash
    end
