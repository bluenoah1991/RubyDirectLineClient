...
module SwaggerClient
  ...
  class Error
    ...
    def valid?
      code_validator = EnumAttributeValidator.new('String', ["MissingProperty", "MalformedData", "NotFound", "ServiceError", "Internal", "InvalidRange", "NotSupported", "NotAllowed", "BadCertificate"])
    ...
    def code=(code)
      validator = EnumAttributeValidator.new('String', ["MissingProperty", "MalformedData", "NotFound", "ServiceError", "Internal", "InvalidRange", "NotSupported", "NotAllowed", "BadCertificate"])
